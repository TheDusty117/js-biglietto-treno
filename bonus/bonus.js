...
//4.1 arrotondamento del prezzo usando solo 2 numeri decimali

let finalPriceFixed = finalPrice.toFixed(2)

console.log(finalPriceFixed)

//4.2 output effettivo del prezzo a schermo

const h1Element = document.getElementById("main_price")

h1Element.innerHTML = finalPriceFixed
